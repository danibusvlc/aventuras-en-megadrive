...
int main( )
{
    ...
    while(1)
    {
        ...
        VDP_drawText(" ENTERO POSITIVO: KLog_U1(t1,v1)       ", 1, 6);
        VDP_drawText(" (2) ''       '': KLog_U1(t1,v1,t2,v2) ", 1, 7);
        VDP_drawText("                                       ", 1, 8);
        VDP_drawText(" ENTERO POSIT y NEGAT: KLog_S1(t1,v1)  ", 1, 9);
        VDP_drawText(" (2) ''   ''   '': KLog_S1(t1,v1,t2,v2)", 1, 10);
        VDP_drawText("                                       ", 1, 11);
        VDP_drawText("                                       ", 1, 12);
        VDP_drawText("                                       ", 1, 13);
        VDP_drawText("                                       ", 1, 14);
        ...
        VDP_drawText(" precision: ????????? ciclos/seg       ", 1, 14);
